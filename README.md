...
[![My Skills](https://skillicons.dev/icons?i=cpp,cs,java,py,js,ts,html,css,tailwind,bootstrap,react,nextjs,redux,vite,flask,dotnet,figma,unreal,bash,regex,npm,powershell,nodejs,netlify,pr,stackoverflow,selenium,sqlite,mysql,vscode,visualstudio,eclipse,pycharm,sublime,apple,linux,ubuntu,windows,git,github&theme=dark)](https://skillicons.dev)  
