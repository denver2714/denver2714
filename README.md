...
[![My Skills](https://skillicons.dev/icons?i=cpp,cs,java,py,js,ts,php,html,css,tailwind,bootstrap,react,nextjs,redux,vite,flask,dotnet,figma,unreal,bash,regex,npm,pytorch,powershell,nodejs,netlify,stackoverflow,selenium,sqlite,mysql,apple,linux,ubuntu,windows,git,replit,github&theme=dark)](https://skillicons.dev)  
